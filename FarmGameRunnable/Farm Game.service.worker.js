...
/** @type {string} */
const CACHE_VERSION = '1724206986|1320205058';
/** @type {string} */
const CACHE_PREFIX = 'Farm Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Farm Game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Farm Game.html","Farm Game.js","Farm Game.offline.html","Farm Game.icon.png","Farm Game.apple-touch-icon.png","Farm Game.worker.js","Farm Game.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Farm Game.wasm","Farm Game.pck"];
